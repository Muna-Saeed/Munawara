  ...
  return (
    <section className="p-8 bg-gray-100 text-gray-700">
      ...
      <div className="flex flex-wrap justify-center gap-6 mb-8">
        <Image src="/images/client1.png" alt="Client 1" className="h-16 w-auto" width={64} height={64} />
        <Image src="/images/client2.png" alt="Client 2" className="h-16 w-auto" width={64} height={64} />
        <Image src="/images/client3.png" alt="Client 3" className="h-16 w-auto" width={64} height={64} />
        <Image src="/images/client4.png" alt="Client 4" className="h-16 w-auto" width={64} height={64} />
      </div>
