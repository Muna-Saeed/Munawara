      ...
      <div className="mt-12 bg-black p-8 rounded shadow-md w-full max-w-3xl mx-auto text-center">
        ...
        <div className="text-black grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          ...
          <div className="bg-white p-4 border rounded flex flex-col items-center">
            <Image src="/icons/web.ico" alt="Web Services" width={50} height={50} className="transition-transform duration-300 hover:scale-110"/>
          ...
          {/* AI Tools */}
          <div className="bg-white p-4 border rounded flex flex-col items-center">
            <Image src="/icons/AI.ico" alt="AI Tools" width={50} height={50} className="transition-transform duration-300 hover:scale-110"/>
          ...
          {/* SEO Services */}
          <div className="bg-white p-4 border rounded flex flex-col items-center">
            <Image src="/icons/seo.ico" alt="SEO Services" width={50} height={50} className="transition-transform duration-300 hover:scale-110"/>
